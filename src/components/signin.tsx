    ...
    return (
        <>
            <div className="bg-[#121723] text-white">
                <div className="flex justify-center items-center lg:px-0 px-5 lg:py-30 py-15">
                    <div className="lg:p-15 p-5 bg-[#1e232e] lg:w-[40%] w-[100%]">
                        <h3 className="font-bold text-[1.8rem] text-center pb-3 lg:pt-0 pt-4">Sign in to your account</h3>
             ...
             0-6.627-5.373-12-12-12z"/>
                        ...
                        <div className="pb-7">
                            ...
                            <input type="password" placeholder="Enter your Password" className="border border-transparent placeholder-[#788293] text-white focus:outline-none bg-[#2c303b] p-3 pl-6  w-full focus:border-[#0f95d0]   " />
                        </div>
                        <div className="flex justify-between pb-9">
                            ...
                            <div>
                                <p className="text-[#4a6cf7] font-medium text-[0.9rem]">Forgot Password?</p>
                            </div>
                        </div>
                        <button type="submit" className="bg-[#4a6cf7]  text-center w-full font-semibold cursor-pointer hover:bg-[#3a6cf7] p-2  h-15">Sign in</button>
                        <div className="pt-7 text-center">
                            <p className="text-[#788293]">Don’t you have an account?<Link to="/signup" className="text-[#4a6cf7]">Sign up</Link></p>
                        </div>
                    </div>
                </div>
            </div>
